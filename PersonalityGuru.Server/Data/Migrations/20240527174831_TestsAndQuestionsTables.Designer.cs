...
namespace PersonalityGuru.Migrations
{
    ...
    [Migration("20240527174831_TestsAndQuestionsTables")]
    partial class TestsAndQuestionsTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonalityGuru.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PersonalityGuru.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PersonalityGuru.Shared.Models.Question", b =>
                {
                    b.HasOne("PersonalityGuru.Shared.Models.Questionnaire", null)
                        .WithMany("Questions")
